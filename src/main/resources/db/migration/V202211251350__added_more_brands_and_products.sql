...
insert into brands (name) values ('Pirelli');

insert into brands (name) values ('Volk Racing');
...
insert into products (description, image, name, price, qty, brand_id, category_id)
